...
object DataLoadHelper {
    ...
    //初始化pag动画
    fun loadPag(src: String, addPag: (ByteArray?) -> Unit, from: Int = FROM_OTHER, onlyDisk: Boolean = false) {
    ...
    //硬盘或者网络获取，
    @Synchronized
    private fun loadPagByDisk(src: String, addPag: (ByteArray?, String) -> Unit, onlyDisk: Boolean = false) {
        //从硬盘缓存中获取
